...
/** Define styles for a newpalette */
...
class NewPaletteForm extends Component {
  ...
  // update colors to include newcolors
  addNewColor() {
    const newColor = {
  ...
  // choose a random color from existing palettes
  addRandomColor(){
  ...
  // react-sortable-hoc take colors passed in call arraymove
